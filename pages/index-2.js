...
export default function Index2() {
  ...
  return (
    <div className="">
      ...
      <header className="pt-6 pb-40 flex bg-emerald-50 bg-opacity-50 dark:bg-emerald-900 dark:bg-opacity-50">
      ...
      <main className="max-w-screen-lg mx-auto -mt-20">
        <img src="https://pbs.twimg.com/profile_images/1457370436476407811/0C_qixrv_400x400.jpg" alt="Rizqy Hidayat" className="w-40 mb-10 rounded-full"/>
        <h1 className="mb-4 text-6xl font-bold">
          Hi! I'm
          <span className="inline-block px-2 bg-emerald-100 dark:bg-emerald-900 dark:bg-opacity-50 dark:text-slate-300">Rizqy Hidayat</span>
